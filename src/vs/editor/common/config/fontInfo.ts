 ...
 * @internal
 */
export const DEFAULT_WINDOWS_FONT_FAMILY = '\'Pragmasevka\', Consolas, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_MAC_FONT_FAMILY = '\'Pragmasevka\', Menlo, Monaco, \'Courier New\', monospace';
/**
 * @internal
 */
export const DEFAULT_LINUX_FONT_FAMILY = '\'Pragmasevka\', \'Droid Sans Mono\', monospace';
/**
 * @internal
 */
